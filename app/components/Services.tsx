...
export default function Services() {
    return (
        <section id="services" className="py-24 px-6 bg-gray-950 text-white relative overflow-hidden">
            
            {/* Background Glow Effects (පිටිපස්සෙන් තියෙන සියුම් එළිය) */}
            <div className="absolute top-0 left-1/4 w-96 h-96 bg-yellow-500/5 rounded-full blur-[120px] pointer-events-none"></div>
