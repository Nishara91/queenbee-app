    ...
    return (
        <nav className="bg-gray-50 text-gray-900 py-4 px-6 sticky top-0 z-50 shadow-sm">
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                ...
                {/* Desktop Menu Links (Gallery එකතු කළා, ලින්ක් අප්ඩේට් කළා) */}
                <div className="hidden md:flex items-center space-x-10 font-bold text-sm tracking-wide text-gray-700">
                    ...
                    <Link href="/gallery" className="text-yellow-600 hover:text-yellow-500 transition-colors">Gallery</Link>
            ...
            {isOpen && (
                <div className="md:hidden pt-4 pb-4 border-t mt-4 border-gray-200">
                    <div className="flex flex-col space-y-4 text-sm font-bold text-gray-800 text-center">
                        <Link href="/" onClick={() => setIsOpen(false)} className="hover:text-yellow-500">Home</Link>
                        ...
                        <Link href="/gallery" onClick={() => setIsOpen(false)} className="text-yellow-600 hover:text-yellow-500">Gallery</Link>
